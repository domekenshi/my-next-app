    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          meaning:
            "要素の下のみに8pxの余白を設定。次の要素との間に距離を作る。",
          demo: "mb-2",
        },
      ],
    },
      ...
      items: [
        {
          ...
          css: "width: 100%;",
          meaning:
            "要素の幅を親要素の100%に設定。フルワイズのレイアウトに使用。",
          demo: "w-full",
        },
        {
          class: "w-1/2",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          meaning:
            "要素の変形を有効化。他のtransformクラスと組み合わせて使用。",
          demo: "transform",
        },
        {
          class: "scale-105",
      ...
      <div className="max-w-7xl mx-auto">
        <header className="mb-8">
          ...
          <p className="text-gray-600">
            Next.jsプロジェクトで使えるTailwind CSSクラスの実用的なガイド
          </p>
        </header>
